...
typewriter.typeString('hello! or hola! or ciao!')
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is zuny.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i go by sunshine as well :).")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm from Colombia")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("and i'm studying biomedical engineering")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("at Universidad de Los Andes.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("and i'm also interested in coding")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
